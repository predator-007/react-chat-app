      ...
      <body className="bodylogin" >
        <Grid>
          <Paper elevation={10} style={paperStyle}>
            ...
            <Button type='submit' style={gmailStyle} variant="contained" color='primary' fullWidth startIcon={<MailOutline/>} onClick={()=>login()}>Sign In using Gmail</Button>
            <Button type='submit' style={fbStyle} variant="contained" color='primary' fullWidth startIcon={<Facebook/>} onClick={()=>login()}>Sign In using Facebook</Button>
            <Button type='submit' style={twitterStyle} variant="contained" color='primary' fullWidth startIcon={<Twitter/>} onClick={()=>login()}>Sign In using Twitter</Button>
          </Paper>
        </Grid>
    </body>
);
